...
const EditableTimeSheet = ({children, editable = true}) => <td contentEditable={editable}>{children}</td>
          ...
          {data.map((val, key) => {
            return (
              <tr key={key}>
                ...
                <EditableTimeSheet editable={editable}>{val.Day}</EditableTimeSheet>
                <EditableTimeSheet editable={editable}>{val.Date}</EditableTimeSheet>
                <EditableTimeSheet editable={editable}>{val.Clockin1}</EditableTimeSheet>
                <EditableTimeSheet editable={editable}>{val.Clockout1}</EditableTimeSheet>
                <td></td>
                <EditableTimeSheet editable={editable}>{val.Clockin2}</EditableTimeSheet>
                <EditableTimeSheet editable={editable}>{val.Clockout2}</EditableTimeSheet>
                <td></td>
                <EditableTimeSheet editable={editable}>{val.Clockin3}</EditableTimeSheet>
                <EditableTimeSheet editable={editable}>{val.Clockout3}</EditableTimeSheet>
                <td></td>
                <EditableTimeSheet editable={editable}>{val.Project}</EditableTimeSheet>
                <EditableTimeSheet editable={editable}>{val.Regular}</EditableTimeSheet>
                <EditableTimeSheet editable={editable}>{val.Overtime}</EditableTimeSheet>
              </tr>
            )
          })}
        </table>
